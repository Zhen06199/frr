...
sudo docker exec -d clab-frr01-client1 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-client2 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-client3 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-client3 ip link set eth0 down
...
sudo docker exec -d clab-frr01-client4 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-client5 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-client6 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server1 ip route add 172.22.174.0/24 via 10.0.3.1 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server2 ip route add 172.22.174.0/24 via 10.0.3.129 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server3 ip route add 172.22.174.0/24 via 10.0.5.129 dev eth1
...
sudo docker exec -d clab-frr01-client7 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client8 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client9 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client10 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client11 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client12 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client13 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client14 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-client15 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server4 ip route add 172.22.174.0/24 via 10.0.5.65 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server5 ip route add 10.10.10.0/24 via 10.0.1.1 dev eth1
sudo docker exec -d clab-frr01-Edge_server5 ip route add 172.22.174.0/24 via 10.0.1.1 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server6 ip route add 172.22.174.0/24 via 10.0.4.1 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server7 ip route add 172.22.174.0/24 via 10.0.2.225 dev eth1
...
sudo docker exec -d clab-frr01-client16 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client17 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client18 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client19 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client20 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client21 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client22 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client23 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client24 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-client25 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
...
sudo docker exec -d clab-frr01-Edge_server8 ip route add 172.22.174.0/24 via 10.0.2.193 dev eth1
